 ...
 * This Endian source code was lifted from https://github.com/LazyDuchess/CC-Merger/blob/master/CCMerger/Endian.cs
...
namespace SimsCCManager.Decryption.Endian
{
    public class Endian
    {
        static Endian()
