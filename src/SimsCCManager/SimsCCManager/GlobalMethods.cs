...
namespace SSAGlobals {
    ...
    public class GlobalVariables {
        ...
        /// </summary>
        //JsonSerializer serializer = new JsonSerializer();
        public static bool BackgroundTasksRunning = false;
        ...
        public static string logfile = Path.Combine(LoggingGlobals.mydocs, @"Sims CC Manager\SCCM.log");
        ...
        public static void Initialize(){
            logfile = Path.Combine(LoggingGlobals.internalLogFolder, "debug.log");
            if (!Directory.Exists(LoggingGlobals.internalLogFolder)) Directory.CreateDirectory(LoggingGlobals.internalLogFolder);
                   ...
                   try
                    {
                        ...
                        System.IO.File.AppendAllText(debuglog, statement);
                    }
                    finally
                    {
